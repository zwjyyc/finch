...
#### 语言模型
* Sklearn &nbsp; | &nbsp; 隐含语义分析 &nbsp; &nbsp; [书名-词云测试](https://github.com/zhedongzheng/finch/blob/master/nlp-models/python/lsa_test.py) &nbsp; | &nbsp;

* Python &nbsp; | &nbsp; 三元模型 &nbsp; &nbsp; [Amazon客户评价-换词测试](https://github.com/zhedongzheng/finch/blob/master/nlp-models/python/trigram_test.py) &nbsp; | &nbsp;
