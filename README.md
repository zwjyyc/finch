...
#### Decomposition
* TensorFlow &nbsp; | &nbsp; Non-negative Matrix Factorization &nbsp; | &nbsp; [Model](https://github.com/zhedongzheng/finch/blob/master/tensorflow-models/matrix_factorization.py) &nbsp; | &nbsp; [Test](https://github.com/zhedongzheng/finch/blob/master/tensorflow-models/matrix_factorization_test.py) &nbsp; | &nbsp;
## Deep Learning
...
## Distributed System
* [Java Multi-threading](https://github.com/zhedongzheng/finch/tree/master/java/MessageSwitchApp)
