...
* TensorFlow &nbsp; | &nbsp; Conv1D LSTM Char-level Language Model &nbsp; | &nbsp; [Model](https://github.com/zhedongzheng/finch/blob/master/tensorflow-models/rnn/conv_rnn_text_gen.py) &nbsp; | &nbsp; [Nietzsche Texts Test](https://github.com/zhedongzheng/finch/blob/master/tensorflow-models/rnn/conv_rnn_text_gen_ni_test.py) &nbsp; | &nbsp; 
#### Autoencoder
