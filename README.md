...
* [Recurrent Neural Network](https://zhedongzheng.github.io/finch/rnn)
    ...
    * TensorFlow | RNN (LSTM) Regressor (Seq2Seq) | [OOP Model](https://github.com/zhedongzheng/finch/blob/master/tensorflow-models/rnn_regr.py) | [Test](https://github.com/zhedongzheng/finch/blob/master/tensorflow-models/rnn_regr_test.py)
