...
* [Supervised Learning](https://github.com/zhedongzheng/finch#supervised-learning)
    ...
    * [Support Vector Machine (SVM)](https://github.com/zhedongzheng/finch#support-vector-machine)
* [Deep Learning](https://github.com/zhedongzheng/finch#deep-learning)
    * [Multilayer Perceptron (MLP)](https://github.com/zhedongzheng/finch#multilayer-perceptron)
    * [Convolutional Neural Network (CNN)](https://github.com/zhedongzheng/finch#convolutional-neural-network)
    * [Recurrent Neural Network (RNN)](https://github.com/zhedongzheng/finch#recurrent-neural-network)
...
* Weight-shared &nbsp; | &nbsp; TensorFlow &nbsp; | &nbsp; [OOP Model](https://github.com/zhedongzheng/finch/blob/master/tensorflow-models/autoencoder_shared_w.py) &nbsp; | &nbsp; [Test](https://github.com/zhedongzheng/finch/blob/master/tensorflow-models/autoencoder_shared_w_test.py)
### Computer Vision
#### OpenCV
* Basic Operations
