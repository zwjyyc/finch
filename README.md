...
* [Theoretical Background](https://zhedongzheng.github.io/finch/svm)
...
* [Theoretical Background](https://zhedongzheng.github.io/finch/conv)
...
* [Theoretical Background](https://zhedongzheng.github.io/finch/rnn)
* TensorFlow  
    ...
    * Language Model &nbsp; | &nbsp; TensorFlow &nbsp; | &nbsp; [OOP Model](https://github.com/zhedongzheng/finch/blob/master/tensorflow-models/rnn_lang_model.py) &nbsp; | &nbsp; [Shakespeare Text Test](https://github.com/zhedongzheng/finch/blob/master/tensorflow-models/rnn_shakespeare_test.py)
* PyTorch
