...
import numpy as np
from modified_tf_classes import BasicDecoder
...
class Seq2Seq:
    ...
    def add_decoder_layer(self):
        ...
        with tf.variable_scope('decode', reuse=True):
            ...
            predicting_decoder = BasicDecoder(
