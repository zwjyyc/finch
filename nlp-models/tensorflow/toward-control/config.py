...
parser.add_argument('--cnn_dropout_rate', type=float, default=0.2)
...
parser.add_argument('--temperature_anneal_bias', type=int, default=24000)
...
parser.add_argument('--stage_1_num_epochs', type=int, default=20)
parser.add_argument('--stage_2_num_epochs', type=int, default=30)
