...
class ConvAE:
    ...
    def build_graph(self):
        ...
        with tf.variable_scope('weights_tied') as scope:
            self.add_conv('shared_W1', [self.kernel_size[0], self.kernel_size[1], self.img_ch, 32])
            scope.reuse_variables()
            self.add_deconv('shared_W1', [self.batch_size, self.img_size[0], self.img_size[1], self.img_ch])
