...
class Conv1DClassifier:
    ...
    def build_graph(self):
        ...
        self.conv1 = self.add_conv1d('conv1', filter_shape=[self.kernel_size, self.embedding_dims, self.n_filters])
        self.conv2 = self.add_conv1d('conv2', filter_shape=[self.kernel_size, self.embedding_dims, self.n_filters])
        self.conv3 = self.add_conv1d('conv3', filter_shape=[self.kernel_size, self.embedding_dims, self.n_filters])
