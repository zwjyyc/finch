...
class CDCGAN:
    def __init__(self, G_size, img_size, img_ch, shape_trace, n_out, kernel_size=(5, 5), strides=(2, 2)):
        self.G_size = G_size
    ...
    def add_input_layer(self):
        ...
        self.label = tf.placeholder(tf.float32, [None, self.n_out])
        self.train_flag = tf.placeholder(tf.bool)
    # end method input_layer


    def add_Generator(self):
        self.G_out = self.generate(tf.concat((self.G_in, self.label), 1))
