...
if __name__ == '__main__':
    ...
    clf = RNNTextClassifier(maxlen, vocab_size, 2, 256, 256)
    log = clf.fit(X_train, Y_train, n_epoch=2, batch_size=batch_size, rnn_keep_prob=(1.0, 1.0),
                  val_data=(X_test, Y_test), en_exp_decay=True)
